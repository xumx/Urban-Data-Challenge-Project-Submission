...
Torque.modules.subtitles = function (torque) {
    torque.subtitles = {
        subs:[
            {
                from:new Date("October 01, 2012 00:01:00"),
                to:new Date("October 01, 2012 05:05:00"),
                sub:"Night time"
            },
            {
                from:new Date("October 01, 2012 05:05:00"),
                to:new Date("October 01, 2012 08:00:00"),
                sub:"Morning"
            },
            {
                from:new Date("October 01, 2012 00:00:00"),
                to:new Date("October 01, 2012 00:00:00"),
